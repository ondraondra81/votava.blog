  ...
  render() {
    ...
    return (
      <Container>
        ...
        <PageNav>
          {previous && (
            <Button to={previous.frontmatter.path ? previous.frontmatter.path : previous.fields.slug } rel="prev">
              ← {previous.frontmatter.title}
            </Button>
          )}

          {next && (
            <Button to={ next.frontmatter.path ? next.frontmatter.path : next.fields.slug } rel="next">
